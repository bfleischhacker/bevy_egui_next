...
- Update Egui to 0.26 ([#3](https://github.com/naomijub/bevy_egui_next/pull/3) by @naomijub).

## [0.25.0] - 11-Dec-2023

### Changed

- Update Egui to 0.25 ([#248](https://github.com/mvlabat/bevy_egui/pull/248) by @MickHarrigan, @naomijub).
